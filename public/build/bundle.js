...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	let current;
    	let dispose;
    	const before_slot_template = /*$$slots*/ ctx[19].before;
    	const before_slot = create_slot(before_slot_template, ctx, /*$$scope*/ ctx[18], get_before_slot_context);
    	const custom_slot_template = /*$$slots*/ ctx[19].custom;
    	const custom_slot = create_slot(custom_slot_template, ctx, /*$$scope*/ ctx[18], get_custom_slot_context);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 69, 2, 1742);
    			add_location(div1, file, 68, 1, 1734);
    			...
    			add_location(div2, file, 56, 0, 1472);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			current = true;
    			dispose = action_destroyer(up_action = /*up*/ ctx[5].call(null, div2));
    		},
    		p: function update(ctx, [dirty]) {
    			if (before_slot && before_slot.p && dirty & /*$$scope*/ 262144) {
    				before_slot.p(get_slot_context(before_slot_template, ctx, /*$$scope*/ ctx[18], get_before_slot_context), get_slot_changes(before_slot_template, /*$$scope*/ ctx[18], dirty, get_before_slot_changes));
    			}

    			if (custom_slot && custom_slot.p && dirty & /*$$scope*/ 262144) {
    				custom_slot.p(get_slot_context(custom_slot_template, ctx, /*$$scope*/ ctx[18], get_custom_slot_context), get_slot_changes(custom_slot_template, /*$$scope*/ ctx[18], dirty, get_custom_slot_changes));
    			}
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Cross> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$set = $$props => {
    		if ("enter" in $$props) $$invalidate(6, enter = $$props.enter);
    		if ("leave" in $$props) $$invalidate(7, leave = $$props.leave);
    		if ("bgColor" in $$props) $$invalidate(0, bgColor = $$props.bgColor);
    		if ("src" in $$props) $$invalidate(1, src = $$props.src);
    		if ("start" in $$props) $$invalidate(8, start = $$props.start);
    		if ("stop" in $$props) $$invalidate(9, stop = $$props.stop);
    		if ("cont" in $$props) $$invalidate(10, cont = $$props.cont);
    		if ("end" in $$props) $$invalidate(11, end = $$props.end);
    		if ("scrollPos" in $$props) $$invalidate(12, scrollPos = $$props.scrollPos);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("seqIn" in $$props) $$invalidate(15, seqIn = $$props.seqIn);
    		if ("seqOut" in $$props) $$invalidate(16, seqOut = $$props.seqOut);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*scrollPos, start, stop*/ 4864) {
    			 $$invalidate(15, seqIn = getSeq(scrollPos, start, stop));
    		}

    		if ($$self.$$.dirty & /*scrollPos, cont, end*/ 7168) {
    			 $$invalidate(16, seqOut = getSeq(scrollPos, cont, end));
    		}

    		if ($$self.$$.dirty & /*scrollPos, start, stop, enter, seqIn, cont, end, leave, seqOut, x, y*/ 131008) {
    			 {
    				if (scrollPos > start && scrollPos <= stop) {
    					if (enter == "left") $$invalidate(13, x = map_range(seqIn, 0, stop - start, -100, 0));
    					if (enter == "right") $$invalidate(13, x = -map_range(seqIn, 0, stop - start, 100, 0));
    					if (enter == "top") $$invalidate(14, y = map_range(seqIn, 0, stop - start, -100, 0));
    					if (enter == "bottom") $$invalidate(14, y = -map_range(seqIn, 0, stop - start, 100, 0));
    				}

    				if (scrollPos > cont && scrollPos <= end) {
    					if (leave == "left") $$invalidate(13, x = -map_range(seqOut, 0, end - cont, 0, 100));
    					if (leave == "right") $$invalidate(13, x = map_range(seqOut, 0, end - cont, 0, 100));
    					if (leave == "top") $$invalidate(14, y = -map_range(seqOut, 0, end - cont, 0, 100));
    					if (leave == "bottom") $$invalidate(14, y = map_range(seqOut, 0, end - cont, 0, 100));
    				}
    		...
    		if ($$self.$$.dirty & /*stop, start, seqIn*/ 33536) {
    			//x y resetters
    			 stop - start - seqIn < 5 && reset();
    		}

    		if ($$self.$$.dirty & /*scrollPos, cont*/ 5120) {
    ...
    class Cross extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*enter*/ ctx[6] === undefined && !("enter" in props)) {
    			console_1.warn("<Cross> was created without expected prop 'enter'");
    		}

    		if (/*leave*/ ctx[7] === undefined && !("leave" in props)) {
    			console_1.warn("<Cross> was created without expected prop 'leave'");
    		}

    		if (/*bgColor*/ ctx[0] === undefined && !("bgColor" in props)) {
    			console_1.warn("<Cross> was created without expected prop 'bgColor'");
    		}

    		if (/*start*/ ctx[8] === undefined && !("start" in props)) {
    			console_1.warn("<Cross> was created without expected prop 'start'");
    		}

    		if (/*stop*/ ctx[9] === undefined && !("stop" in props)) {
    			console_1.warn("<Cross> was created without expected prop 'stop'");
    		}

    		if (/*cont*/ ctx[10] === undefined && !("cont" in props)) {
    			console_1.warn("<Cross> was created without expected prop 'cont'");
    		}

    		if (/*end*/ ctx[11] === undefined && !("end" in props)) {
    			console_1.warn("<Cross> was created without expected prop 'end'");
    		}
    	}
    ...
    function create_before_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 33, 3, 824);
    			add_location(p, file$1, 34, 3, 860);
    			attr_dev(div, "slot", "before");
    			add_location(div, file$1, 32, 2, 799);
    		},
    		m: function mount(target, anchor) {
    ...
    // (32:1) <Cross enter='right' leave='bottom' start={20}  stop={300} cont={400} end={700} scrollPos={scrollPos} bgColor='purple'>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(32:1) <Cross enter='right' leave='bottom' start={20}  stop={300} cont={400} end={700} scrollPos={scrollPos} bgColor='purple'>",
    		ctx
    	});
    ...
    function create_custom_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 40, 3, 1252);
    			attr_dev(div, "slot", "custom");
    			add_location(div, file$1, 39, 2, 1229);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h1);
